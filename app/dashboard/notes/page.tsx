  ...
  return (
    <div className="flex h-screen flex-col bg-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`w-60 shrink-0 border-r-4 border-black bg-gray-50 flex-col ${selectedFile ? 'hidden lg:flex' : 'flex'}`}>
        ...
        <main className="flex flex-1 flex-col overflow-hidden">
          {selectedFile && !selectedFile.name.endsWith('.md') ? (
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
              <div className="flex shrink-0 items-center justify-between border-b-4 border-black bg-[#FFE500] px-4 py-3">
                <div className="flex items-center gap-2 min-w-0">
                  <button onClick={() => setSelectedFile(null)} className="lg:hidden shrink-0 border-2 border-black bg-white px-2 py-1 text-xs font-black">← 목록</button>
            ...
            <>
              ...
              <div className="lg:hidden shrink-0 flex items-center gap-2 border-b-2 border-black bg-[#FFE500] px-3 py-2">
        ...
        <aside className={`shrink-0 border-l-4 border-black bg-gray-50 transition-all hidden lg:flex flex-col ${showMetaPanel ? 'w-56' : 'w-10'}`}>
          <div className="flex h-full flex-col">
